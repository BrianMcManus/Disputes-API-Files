...
$ch = curl_init();
$url = "https://api.sandbox.paypal.com/v1/customer/disputes/$disputeId/escalate";
...
//$vars['action'] = "SELLER_EVIDENCE";

$vars['note'] = "Escalating to PayPal claim for resolution.";
