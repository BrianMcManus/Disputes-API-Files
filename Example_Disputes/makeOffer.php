...
$ch = curl_init();
$url = "https://api.sandbox.paypal.com/v1/customer/disputes/$disputeId/make-offer";
...
$vals['currency_code'] = 'GBP';
$vals['value'] = '12.00';

$vars['note'] = "Offer refund with replacement item.";
$vars['offer_amount'] = $vals;
$vars['offer_type'] = "REFUND_WITH_REPLACEMENT";
